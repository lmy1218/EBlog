...
<head>
	...
	<title>爱问社区</title>
	<link rel="stylesheet" type="text/css" href="/box/css/normalize.css" /><!--CSS RESET-->
	<link rel="stylesheet" type="text/css" href="/box/css/htmleaf-demo.css"><!--演示页面样式，使用时可以不引用-->
	<link rel="stylesheet" href="/box/css/style.css">
</head>
<body>
	<div class="htmleaf-container">
		<header class="htmleaf-header">
			<h1>欢迎来到 | 爱问社区 <span>Let`s go</span></h1>
			<div class="htmleaf-links">
				<a class="htmleaf-icon icon-htmleaf-home-outline" href="/index" title="jQuery之家" target="_blank"><span> 主页</span></a>
				<a class="htmleaf-icon icon-htmleaf-arrow-forward-outline" href="/login" title="返回下载页" target="_blank"><span> 去登陆</span></a>
			</div>
		</header>
