...
<div class="fly-panel fly-column">
    <div class="layui-container">
        <ul class="layui-clear">
            <li class="${(0 == currentCategoryId) ? string('i-hlayuide-xs layui-this', '')}"><a href="/">首页</a></li>
            <#list categorys as item >
                <li class="${(item.id == currentCategoryId) ? string('i-hlayuide-xs layui-this', '')}"><a href="/category/${item.id}">${item.name}</a></li>
            </#list>
