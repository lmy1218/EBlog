...
<div class="layui-container fly-marginTop fly-user-main">
  <#--左侧导航栏-->
  <@usercenterleft  level=2 ></@usercenterleft>
      ...
      <div class="layui-tab-content" style="padding: 20px 0;">
        <div class="layui-form layui-form-pane layui-tab-item layui-show">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux"><a href="javascript:;" style="font-size: 12px; color: #4f99cf;">邮箱为注册邮箱，不能更改！</a></div>
          </div>
          <#--昵称-->
          <div class="layui-form-item">
          ...
          <#--电话-->
          <div class="layui-form-item">
            <label for="L_mobile" class="layui-form-label">电话</label>
            <div class="layui-input-inline">
              <input type="text" id="L_mobile" name="mobile" autocomplete="off" value="${user.mobile}" class="layui-input">
            </div>
          </div>
          <#--微信-->
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="text" id="L_wechat" name="wechat" autocomplete="off" value="${user.wechat}" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="date" id="L_birthday" name="birthday" autocomplete="off" value="${user.created?string("yyyy-MM-dd")}" class="layui-input">
            </div>
          </div>
          <#--签名-->
        ...
        <@shiro.hasRole name="admin">
          <div class="layui-form layui-form-pane layui-tab-item">
            <form action="/admin/init" method="post">
              <div class="layui-form-item">
                <button class="layui-btn" key="set-mine" lay-filter="*" lay-submit alert="true">开始同步</button>
              </div>
            </form>
          </div>
        </@shiro.hasRole>
